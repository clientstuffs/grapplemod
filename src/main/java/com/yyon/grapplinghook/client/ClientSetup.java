...
public class ClientSetup {
	...
	public static KeyMapping key_boththrow = createKeyBinding(new NonConflictingKeyBinding("key.boththrow.desc", InputConstants.UNKNOWN.getValue(), "key.grapplemod.category"));
